...
import 'other_post_details_model.dart';
export 'other_post_details_model.dart';

class OtherPostDetailsWidget extends StatefulWidget {
  const OtherPostDetailsWidget({
    super.key,
  ...
  static String routeName = 'otherPostDetails';
  static String routePath = '/otherPostDetails';

  @override
  State<OtherPostDetailsWidget> createState() => _OtherPostDetailsWidgetState();
}

class _OtherPostDetailsWidgetState extends State<OtherPostDetailsWidget>
    with TickerProviderStateMixin {
  late OtherPostDetailsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OtherPostDetailsModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'otherPostDetails'});
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'OTHER_POST_DETAILS_Icon_ncjdfm8k_ON_TAP');
                              ...
                              StreamBuilder<List<UserPostsRecord>>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  return InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'OTHER_POST_DETAILS_Image_tsgvgmg0_ON_TAP');
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                          ...
                                          children: [
                                            if (!columnUserPostsRecord.likes
                                              ...
                                              InkWell(
                                                ...
                                                onTap: () async {
                                                  logFirebaseEvent(
                                                      'OTHER_POST_DETAILS_PAGE_notLiked_ON_TAP');
                                                  logFirebaseEvent(
                                            ...
                                            if (columnUserPostsRecord.likes
                                              ...
                                              InkWell(
                                                ...
                                                onTap: () async {
                                                  logFirebaseEvent(
                                                      'OTHER_POST_DETAILS_PAGE_Liked_ON_TAP');
                                                  logFirebaseEvent(
                                                      'Liked_backend_call');
                                        ...
                                        InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'OTHER_POST_DETAILS_Icon_2pjg4e12_ON_TAP');
                                            logFirebaseEvent(
                                                'Icon_bottom_sheet');
                                  ...
                                  Align(
                                    ...
                                    child: Padding(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'OTHER_POST_DETAILS_Text_5bzg5kg1_ON_TAP');
