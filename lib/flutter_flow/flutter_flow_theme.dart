...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF2F5651);
  late Color secondary = const Color(0xFFA8B59F);
  late Color tertiary = const Color(0xFFF1EDE1);
  ...
  late Color darkGreen = Color(0xFF2F5651);
  late Color lightGreen = Color(0xFFA8B59F);
  late Color beige = Color(0xFFF1EDE1);
}
...
class ThemeTypography extends Typography {
  ...
  TextStyle get displayLarge => GoogleFonts.josefinSans(
  ...
  TextStyle get headlineMedium => GoogleFonts.josefinSans(
        color: theme.primary,
  ...
  TextStyle get headlineSmall => GoogleFonts.josefinSans(
        color: theme.primaryText,
