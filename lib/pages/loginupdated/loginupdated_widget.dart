...
import 'loginupdated_model.dart';
export 'loginupdated_model.dart';

class LoginupdatedWidget extends StatefulWidget {
  const LoginupdatedWidget({super.key});

  static String routeName = 'loginupdated';
  static String routePath = '/loginupdate';

  @override
  State<LoginupdatedWidget> createState() => _LoginupdatedWidgetState();
}

class _LoginupdatedWidgetState extends State<LoginupdatedWidget>
    with TickerProviderStateMixin {
  late LoginupdatedModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LoginupdatedModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'loginupdated'});
                                                ...
                                                children: [
                                                  ...
                                                  Align(
                                                    ...
                                                    child: FFButtonWidget(
                                                      ...
                                                      onPressed: () async {
                                                        logFirebaseEvent(
                                                            'LOGINUPDATED_PAGE_SIGN_UP_BTN_ON_TAP');
                                                        logFirebaseEvent(
                                                  ...
                                                  Align(
                                                    ...
                                                    child: Padding(
                                                      ...
                                                      child: FFButtonWidget(
                                                        onPressed: () async {
                                                          logFirebaseEvent(
                                                              'LOGINUPDATED_PAGE_SIGN_IN_BTN_ON_TAP');
                                                          logFirebaseEvent(
                                                              'Button_validate_form');
                                                          if (_model.formKey2
                                                                      .currentState ==
