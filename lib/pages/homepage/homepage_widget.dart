                                                ...
                                                Container(
                                                  ...
                                                  child: Align(
                                                    ...
                                                    child: InkWell(
                                                      ...
                                                      onTap: () async {
                                                        logFirebaseEvent(
                                                            'HOMEPAGE_PAGE_Icon_kda9zw4q_ON_TAP');
                                                        logFirebaseEvent(
                                                            'Icon_navigate_to');
                                ...
                                child: Stack(
                                  children: [
                                    ...
                                    InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'HOMEPAGE_PAGE_Container_vbqt8ijy_ON_TAP');
                                        logFirebaseEvent(
                                            'Container_navigate_to');

                                        context.pushNamed(
                                            WeightLossWidget.routeName);
                                      },
                                      child: Container(
                                        width:
                                            MediaQuery.sizeOf(context).width *
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'HOMEPAGE_PAGE_Container_ygkqc78e_ON_TAP');
                                          logFirebaseEvent(
                                              'Container_navigate_to');

                                          context.pushNamed(
                                              MuscleBuildingWidget.routeName);
                                        },
                                        child: Container(
                                          width:
                                              MediaQuery.sizeOf(context).width *
